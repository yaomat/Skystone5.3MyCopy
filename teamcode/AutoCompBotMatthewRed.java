...
@Autonomous(name="AutoCompBotMatthewRed", group ="Concept")

public class AutoCompBotMatthewRed extends LinearOpMode {
    ...
    @Override public void runOpMode() {
        ...
        runtime.reset();
        forward(0.5);
        //if needed, change back to 1.125
        waitfor(1.125);
        runtime.reset();
        strafeleft(0.175);
